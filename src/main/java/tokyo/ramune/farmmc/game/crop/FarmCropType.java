...
public enum FarmCropType {
    ...
    WHEAT(World.Environment.NORMAL, Range.closed(0.5, 0.8), false, List.of(Material.WHEAT, Material.WHEAT_SEEDS)),
    BEETROOT(World.Environment.NORMAL, Range.closed(-0.5, 0.2), false, List.of(Material.BEETROOTS, Material.BEETROOT, Material.BEETROOT_SEEDS)),
    CARROT(World.Environment.NORMAL, Range.closed(0.2, 1.0), false, List.of(Material.CARROTS, Material.CARROT)),
    POTATO(World.Environment.NORMAL, Range.closed(0.2, 1.0), false, List.of(Material.POTATOES, Material.POTATO)),
    MELON(World.Environment.NORMAL, Range.closed(0.9, 1.2), false, List.of(Material.MELON, Material.MELON_SEEDS)),
    PUMPKIN(World.Environment.NORMAL, Range.closed(0.2, 1.0), false, List.of(Material.PUMPKIN, Material.PUMPKIN_SEEDS)),
    BAMBOO(World.Environment.NORMAL, Range.closed(0.8, 0.99), true, List.of(Material.BAMBOO, Material.BAMBOO_SAPLING)),
    COCOA_BEAN(World.Environment.NORMAL, Range.closed(0.9, 0.99), false, List.of(Material.COCOA, Material.COCOA_BEANS)),
    SUGAR_CANE(World.Environment.NORMAL, Range.closed(0.8, 1.2), true, List.of(Material.SUGAR_CANE)),
    SWEET_BERRY(World.Environment.NORMAL, Range.closed(0.2, 0.3), false, List.of(Material.SWEET_BERRIES, Material.SWEET_BERRY_BUSH)),
    CACTUS(World.Environment.NORMAL, Range.closed(1.2, 2.0), true, List.of(Material.CACTUS)),
    MUSHROOM(World.Environment.NORMAL, Range.closed(0.2, 1.2), true, List.of(Material.BROWN_MUSHROOM, Material.RED_MUSHROOM)),
    KELP(World.Environment.NORMAL, Range.closed(0.5, 0.5), true, List.of(Material.KELP, Material.KELP_PLANT)),
    ...
    public int getExp() {
        ...
        exp = 10 - (int) Math.floor((temperatureRange.upperEndpoint() - temperatureRange.lowerEndpoint()) * 10.0);
