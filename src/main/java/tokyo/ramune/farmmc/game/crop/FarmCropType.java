...
public enum FarmCropType {
    ...
    MELON(World.Environment.NORMAL, false, List.of(Material.MELON, Material.MELON_SEEDS)),
    PUMPKIN(World.Environment.NORMAL, false, List.of(Material.PUMPKIN, Material.PUMPKIN_SEEDS)),
